...
dll = cdll.LoadLibrary(r"C:\Users\dickr\git\PokerEquityCalculator\x64\Release\EquityCalculatorMontecarlo.dll")


def _runner(my_cards, cards_on_table, players, expected_result):
    """Montecarlo test"""
    equity = dll.montecarlo(my_cards, cards_on_table, players, 10000)
