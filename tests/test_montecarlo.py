...
from tools import montecarlo_python as mc
...
class TestHandEvaluation(unittest.TestCase):
    def test_twopairs1(
            self):
        simulator = mc.MonteCarlo()

        simulator.player_final_cards = [['3H', '3S', '4H', '4S', '8S', '8C', 'QH'],
                                         ['KH', '6C', '4H', '4S', '8S', '8C', 'QH']]
        log.info(eval_best_hand(simulator.player_final_cards)[1])
        log.info("\r")
        self.assertEqual(
            simulator.player_final_cards.index(eval_best_hand(simulator.player_final_cards)[0]),
            1)
    ...
    def test_evaluator(
        ...
        simulator.player_final_cards = [['8H', '8D', 'QH', '7H', '9H', 'JH', 'TH'],
        ...
        simulator.player_final_cards = [['AS', 'KS', 'TS', '9S', '7S', '2H', '2H'],
        ...
        simulator.player_final_cards = [['8S', 'TS', '8H', 'KS', '9S', 'TH', 'KH'],
        ...
        simulator.player_final_cards = [['2D', '2H', 'AS', 'AD', 'AH', '8S', '7H'],
        ...
        simulator.player_final_cards = [['7C', '7S', '7H', 'AD', 'KS', '5S', '8H'],
        ...
        simulator.player_final_cards = [['7C', '7C', 'AC', 'AC', '8C', '8S', '7H'],
        ...
        simulator.player_final_cards = [['AC', 'JS', 'AS', '2D', '5H', '3S', '3H'],
        ...
        simulator.player_final_cards = [['7C', '5S', '3S', 'JD', '8H', '2S', 'KH'],
        ...
        simulator.player_final_cards = [['2C', '2D', '4S', '4D', '4H', '8S', 'KH'],
        ...
        simulator.player_final_cards = [['7H', '7S', '3S', 'JD', '8H', '2S', 'KH'],
        ...
        simulator.player_final_cards = [['AS', '8H', 'TS', 'JH', '3H', '2H', 'AH'],
        ...
        simulator.player_final_cards = [['9S', '7H', 'KS', 'KH', 'AH', 'AS', 'AC'],
...
class TestMonteCarlo(unittest.TestCase):
    def test_monteCarlo(self):  # Unittest to ensure correct winning probabilities are returned
        def test_run(simulation, my_cards, cards_on_table, players, expected_results, opponent_range=1.0):
            ...
            for _ in range(test_runs):
                ...
                logger = MagicMock()
                simulation.run_montecarlo(logger, my_cards, cards_on_table, players, 1, maxRuns=max_runs,
        ...
        players = 2
        test_run(simulator, my_cards, cards_on_table, players, expected_results)
        ...
        players = 3
        test_run(simulator, my_cards, cards_on_table, players, expected_results, opponent_range=opponent_range)
